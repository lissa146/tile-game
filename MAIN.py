...
while 1: #game loop###########################################################
	...
	if state == 1 and mousePos[0]>500 and mousePos[0]<450 and mousePos[1]>400 and mousePos[1]<550:
		button2 = True
	
	else:
		button2 = False

	if state == 1 and mousePos[0]>800 and mousePos[0]<470 and mousePos[1]>400 and mousePos[1]<550:
		button3 = True
	...
	if state == 1 and button1 == True and mouseDown == True:
		state = 2
	elif button2 == True and mouseDown == True:
		state = 2
	elif button3 == True and mouseDown == True:
		state = 2
